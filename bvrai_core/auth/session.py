...
class SessionManager:
    ...
    async def validate_session_token(
        ...
        # Verify token hash matches (use constant-time comparison to prevent timing attacks)
    ...
    async def refresh_session(
        ...
        # Verify refresh token hash (use constant-time comparison to prevent timing attacks)
